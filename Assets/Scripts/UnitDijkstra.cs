...
public class UnitDijkstra : MonoBehaviour
{
    ...
    void NewTarget(string gameObject)
    {
        ...
        Dijkstra.instance.TargetPosition = Target.transform;
        Dijkstra.instance.FindShortPath(transform.position, Target.transform.position);
