...
public class UnitThreeDJ : MonoBehaviour
{
    public int speed;
    ...
    public void Awake()
    {
        speed = GridWorld.instance.speed;
    ...
    {
        Dijkstra.instance.TargetPosition = gameObject.transform;
        Dijkstra.instance.FindShortPath(transform.position, gameObject.transform.position);
        WalkFinalPath = Dijkstra.PathToWalk;
        count = 0;
